...
Adaptado de `snk-ai-registry` (Sankhya AI Prompt Registry) — skill `db-migrations` (apenas as partes agnósticas de banco; formato de micromódulo/datadictionary EIP não se aplica ao Addon Studio).
