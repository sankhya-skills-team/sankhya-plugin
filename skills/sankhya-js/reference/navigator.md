...
Arquivos: [navigator.directive.js](../../../../sankhya-js/src/components/navigator/navigator.directive.js), [navigator.controller.js](../../../../sankhya-js/src/components/navigator/navigator.controller.js).
...
Handlers via atributo (`sk-save-handler`, etc.) e via API sao intercambiaveis — `api.saveHandler` sobrescreve o de scope quando presente ([navigator.controller.js:298-310](../../../../sankhya-js/src/components/navigator/navigator.controller.js#L298-L310)).
...
Sem `alwaysNavigation` e com dirty, prev/next ficam desabilitados ate salvar ou cancelar ([:229-259](../../../../sankhya-js/src/components/navigator/navigator.controller.js#L229-L259)).
...
Driven pelo parametro MGE `global.notifica.alteracao.dataset` ([:6](../../../../sankhya-js/src/components/navigator/navigator.controller.js#L6)). Quando ativo, popover `edition-alert-popover-{componentId}` aparece uma vez por registro apos o dataset ficar dirty (flag `_showedEditionAlertForThisRecord` reseta em `currentLineChanged`).
...
3. **`show-crud === false` alem de esconder add/remove chama `dataset.setEnableDeleteFromNavigator(false)`** ([:115](../../../../sankhya-js/src/components/navigator/navigator.controller.js#L115)). Isso afeta tambem delete por teclado ou menu de contexto.
