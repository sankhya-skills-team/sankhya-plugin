...
Evidencia real no commons: [FichaParceiroContainer.service.js](../../../../../sankhya-js/src/commons/fichaparceiro/FichaParceiroContainer/FichaParceiroContainer.service.js).
...
`ignoreLoadingBar` e `asOption` — vai para `options`, nao para `variables`. `.call()` e o alias registrado em `.buildFn(..., 'call')` ([serviceproxy.service.js:52](../../../../../sankhya-js/src/core/util/http/serviceproxy.service.js#L52)).
...
Evidencia simples: [button.module.js](../../../../../sankhya-js/src/components/button/button.module.js) + [button.directive.js](../../../../../sankhya-js/src/components/button/button.directive.js).
...
Estrutura: [src/components/popup/](../../../../../sankhya-js/src/components/popup/)
```
...
Evidencia: [componentregistry.service.js:107-150](../../../../../sankhya-js/src/core/services/registry/componentregistry.service.js#L107-L150).
...
Evidencia: [metadataprovider.service.js:185-235](../../../../../sankhya-js/src/core/metadataprovider/metadataprovider.service.js#L185-L235).
...
O backend retorna `data.clientEvents = [{ id: 'CONFIRMACAO_SAIDA', ...payload }]` e o frontend invoca todos os handlers registrados ([serviceproxy.service.js:309-322](../../../../../sankhya-js/src/core/util/http/serviceproxy.service.js#L309-L322)).
...
Evidencia: [i18n.service.js:17,101-113,116-122](../../../../../sankhya-js/src/i18n/i18n.service.js#L17).
...
Se o workspace do GWT estiver disponivel, usa `workspace.downloadFile`. Caso contrario, abre nova aba com URL `/mge/visualizadorArquivos.mge?chaveArquivo=X&foo=bar` ([workspace.service.js:99-113](../../../../../sankhya-js/src/core/workspace/workspace.service.js#L99-L113)).
...
Evidencia: [framework.config.js:54-73](../../../../../sankhya-js/src/core/framework.config.js#L54-L73).
...
O modulo `snk.commons` agrega as commons ([commons.module.js](../../../../../sankhya-js/src/commons/commons.module.js)). Cada subpasta declara seu proprio sub-modulo e o registra onde for preciso.

Servicos em commons usam `angular.module('snk.commons')` diretamente, como em [FichaParceiroContainer.service.js:1-3](../../../../../sankhya-js/src/commons/fichaparceiro/FichaParceiroContainer/FichaParceiroContainer.service.js#L1-L3).
