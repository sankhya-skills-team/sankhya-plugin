...
Arquivos em [src/components/dataset/](../../../../../sankhya-js/src/components/dataset/). Controller com ~7600 linhas em [dataset.controller.js](../../../../../sankhya-js/src/components/dataset/dataset.controller.js).
...
Atributos mais usados (ver [dataset.directive.js:169-194](../../../../../sankhya-js/src/components/dataset/dataset.directive.js#L169-L194)):
- `entity-name` — nome da entidade
- `id` — publica o controller em `$parent[id]` e no `appController` ([dataset.directive.js:196-205](../../../../../sankhya-js/src/components/dataset/dataset.directive.js#L196-L205))
...
`_standAlone = $attrs.hasOwnProperty('skStandalone')` ([dataset.controller.js:40](../../../../../sankhya-js/src/components/dataset/dataset.controller.js#L40)).

`<sk-dsfield-md>` cria o metadado programaticamente ([datasetfieldmd.directive.js:63](../../../../../sankhya-js/src/components/dataset/datasetfieldmd.directive.js#L63) — campo com `standAlone: true`).

### Handlers customizados (obrigatorios no standalone, opcionais no conectado)

Ver [dataset.directive.js:35-49](../../../../../sankhya-js/src/components/dataset/dataset.directive.js#L35-L49):
...
`dataset.whenMetadataLoaded()` ([dataset.controller.js:437](../../../../../sankhya-js/src/components/dataset/dataset.controller.js#L437)) retorna promise que resolve quando metadados estao prontos — util para configurar `addFieldValueEvaluator` antes do refresh.
...
|---|---|---|---|
| `addLineChangeListener(fn)` | [5904](../../../../../sankhya-js/src/components/dataset/dataset.controller.js#L5904) | Indice atual muda | `(newIndex)` |
| `addSelectionChangeListener(fn)` | [5925](../../../../../sankhya-js/src/components/dataset/dataset.controller.js#L5925) | Selecao multipla muda | `()` |
| `addRefreshedListener(fn)` | [5946](../../../../../sankhya-js/src/components/dataset/dataset.controller.js#L5946) | Apos cada refresh | `(reason)` — ver `DatasetEvents.REFRESH_REASON_*` |
| `addDataModifiedListener(fn)` | [5967](../../../../../sankhya-js/src/components/dataset/dataset.controller.js#L5967) | Qualquer campo modificado | `(fieldName, newValue, oldValue)` |
| `addFieldModifiedListener(fields, fn)` | [5989](../../../../../sankhya-js/src/components/dataset/dataset.controller.js#L5989) | Campos especificos modificados | `(fieldName, newValue, oldValue)` |
| `addDataSavedListener(fn)` | [6023](../../../../../sankhya-js/src/components/dataset/dataset.controller.js#L6023) | Apos save | `(isNew, records)` |
| `addEditionCanceledListener(fn)` | [6045](../../../../../sankhya-js/src/components/dataset/dataset.controller.js#L6045) | `cancelEdition()` | `()` |
| `addInsertionModeListener(fn)` | [6076](../../../../../sankhya-js/src/components/dataset/dataset.controller.js#L6076) | Entrou em modo insercao | `(indexBeforeInsert, dataset)` |
| `addRowMetaDataListener(fn)` | [6098](../../../../../sankhya-js/src/components/dataset/dataset.controller.js#L6098) | Metadata de linha alterada (RMD) | `(...)` |
| `addRecordRemovedListener(fn)` | [6146](../../../../../sankhya-js/src/components/dataset/dataset.controller.js#L6146) | Registro removido | `(record)` |
| `addAllObserverEventsListener(fn)` | [6167](../../../../../sankhya-js/src/components/dataset/dataset.controller.js#L6167) | Qualquer evento do observer | `(event, parameters)` |
| `addSaveAvoidListener(fn)` | [6188](../../../../../sankhya-js/src/components/dataset/dataset.controller.js#L6188) | Save abortado por validacao | `(nullFieldNames, dataset)` |
| `addFinishedEditionListener(fn)` | [7583](../../../../../sankhya-js/src/components/dataset/dataset.controller.js#L7583) | Usuario saiu do campo editado | — |

### Outros registradores (nao sao "listeners" mas sao pontos de extensao)

| Metodo | Linha | Efeito |
|---|---|---|
| `addFieldValueEvaluator(fieldName, fn, triggerFields)` | [1783](../../../../../sankhya-js/src/components/dataset/dataset.controller.js#L1783) | Recalcula `fieldName` quando qualquer `triggerFields` muda. Retorno da `fn` vira valor |
...
| `addFieldMetadataInterceptor(fieldName, fn)` | [6054](../../../../../sankhya-js/src/components/dataset/dataset.controller.js#L6054) | Ajusta metadata do campo no carregamento (readOnly, required, visible, ...) |
...
Tres conjuntos em [dataset.constant.js](../../../../../sankhya-js/src/components/dataset/dataset.constant.js):
...
Escuta via `dataset.addEventListener(DatasetEvents.ON_METADATA_UPDATED, fn)` ([dataset.controller.js:3532](../../../../../sankhya-js/src/components/dataset/dataset.controller.js#L3532) — exemplo real de uso). `EventBus` e mixado via `ObjectUtils.extend(self, EventBus)` ([dataset.controller.js:8](../../../../../sankhya-js/src/components/dataset/dataset.controller.js#L8)).
...
|---|---|---|
| Metadados carregados? | `whenMetadataLoaded()` | [437](../../../../../sankhya-js/src/components/dataset/dataset.controller.js#L437) |
| Dataset ja carregou registros pelo menos uma vez? | `isLoaded()` | [1119](../../../../../sankhya-js/src/components/dataset/dataset.controller.js#L1119) |
| Tem algum registro? | `isEmpty()` / `size()` | [345](../../../../../sankhya-js/src/components/dataset/dataset.controller.js#L345) |
| Esta em modo de edicao? | `isEditMode()` / `isAnyEditMode()` / `isInsertionMode()` / `isCopyingRecord()` | [425-428](../../../../../sankhya-js/src/components/dataset/dataset.controller.js#L425-L428) |
| Registro corrente foi modificado? | `isRecordDirty()` | — |
| Refresh em andamento? | `isRefreshing()` | [431](../../../../../sankhya-js/src/components/dataset/dataset.controller.js#L431) |
...
O retorno do handler pode ser sincrono (array) ou promise. Se for objeto com `responseBody`, o dataset usa `responseBody` como valor ([dataset.directive.js:36-38](../../../../../sankhya-js/src/components/dataset/dataset.directive.js#L36-L38)).
