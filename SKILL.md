...
## Fonte de verdade profunda

A análise completa do framework (2339 linhas da `JapeSession`, fluxos internos, detecção de deadlock, metadados XML, lifecycle de conexões) está em [docs/agents/component-deep-analyzer/component-analysis-jape.md](../../../docs/agents/component-deep-analyzer/component-analysis-jape.md). Consulte-a quando precisar entender *por que* uma regra existe, não apenas *como* aplicar.
