...
> apoiado pela skill `frontend-design` e pelo Design System. Esta skill (gadget XML
...
- Se não houver fonte confiável, consultar a skill **sankhya-dicionario** para verificar os campos reais da tabela antes de incluí-los na query
- Campos de tabelas nativas Sankhya conhecidas (TGFCAB, TGFITE, TGFPAR, TGFFIN, TGFTOP, TSIEMP, etc.) podem ser usados com confiança — mas confirmar nomes exatos via **sankhya-dicionario** quando houver dúvida
