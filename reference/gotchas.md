...
[serviceproxy.service.js:151-157](../../../../../sankhya-js/src/core/util/http/serviceproxy.service.js#L151-L157):
...
[metadataprovider.service.js:43-45](../../../../../sankhya-js/src/core/metadataprovider/metadataprovider.service.js#L43-L45):
...
[metadataprovider.service.js:18](../../../../../sankhya-js/src/core/metadataprovider/metadataprovider.service.js#L18):
...
[componentregistry.service.js:114-118](../../../../../sankhya-js/src/core/services/registry/componentregistry.service.js#L114-L118):
...
[componentregistry.service.js:80-96](../../../../../sankhya-js/src/core/services/registry/componentregistry.service.js#L80-L96):
...
[fluidbuilder.service.js:63-65](../../../../../sankhya-js/src/core/util/fluidbuilder/fluidbuilder.service.js#L63-L65):
...
`ServiceProxy.builder()` marca `serviceName` como required ([serviceproxy.service.js:46](../../../../../sankhya-js/src/core/util/http/serviceproxy.service.js#L46)). Esquecer `.serviceName(...)` derruba com `Error` sincrono — nao volta como rejection de promise.

---

## 7. `config.callback` suprime o `.then`

[serviceproxy.service.js:289-293](../../../../../sankhya-js/src/core/util/http/serviceproxy.service.js#L289-L293):
...
Mesmo vale para `exceptionCallback`: se setado, o reject pode nao chegar em `.catch` ([serviceproxy.service.js:408-412](../../../../../sankhya-js/src/core/util/http/serviceproxy.service.js#L408-L412)).

---

## 8. Erro de servico exibe popup por default

[serviceproxy.service.js:447-459](../../../../../sankhya-js/src/core/util/http/serviceproxy.service.js#L447-L459):
...
[framework.config.js:47](../../../../../sankhya-js/src/core/framework.config.js#L47):
...
[workspace.service.js:71-97](../../../../../sankhya-js/src/core/workspace/workspace.service.js#L71-L97):
...
Ver: [button.module.js](../../../../../sankhya-js/src/components/button/button.module.js) + [button.directive.js:41-42](../../../../../sankhya-js/src/components/button/button.directive.js#L41-L42).

---

## 12. Build usa Grunt 0.4.5 + Babel 7

[package.json:30-40](../../../../../sankhya-js/package.json#L30-L40):
...
[i18n.service.js:6](../../../../../sankhya-js/src/i18n/i18n.service.js#L6):
...
[workspace.service.js:5](../../../../../sankhya-js/src/core/workspace/workspace.service.js#L5):
