...
O código de referência está em `JAPE/src/br/com/sankhya/jape/sql/MacroTranslator.java` (~800 linhas). Há mais de 40 macros compiladas como regex em bloco estático. Se precisar de uma macro que não está nesta lista, consulte o arquivo ou o relatório em [component-analysis-jape.md](../../../../docs/agents/component-deep-analyzer/component-analysis-jape.md).
